...
const fdMob = new URL("./Images/banners/fd_mob.png", import.meta.url).href;
const fdWeb = new URL("./Images/banners/fd_web.png", import.meta.url).href;

const walkMob = new URL("./Images/banners/walk_mob.png", import.meta.url).href;
const walkWeb = new URL("./Images/banners/walk_web.png", import.meta.url).href;

const theyamMob = new URL("./Images/banners/theyyam_mob.png", import.meta.url).href;
